    ...
    <div class="mdl-cell mdl-cell--2-offset-desktop mdl-cell--8-col mdl-color-text--grey-800 mdl-grid">
        @foreach($items as $item)
            <div class="mdl-cell mdl-cell--3-col-desktop mdl-cell--4-col-tablet mdl-card my-card mdl-shadow--2dp">
                <div class="mdl-card__title mdl-card--expand my-card-background" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0,0,0,0.49) 100%), url({{ asset('images/'.($item->page_photo_path ?? 'default.png')) }});">
